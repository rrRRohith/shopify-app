...
<div class="editor-section position-relative p-4 section-holder">
    <span class="section-divider"><i class="fa-solid fa-grip-vertical"></i> HTML</span>
    <input type="hidden" name="template_contents[{{ $section_id }}][section_type]" value="html">
    ...
    <div class="sectionAction side-action">
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 border-0 text-overflow" aria-labelledby="dropdownMenuButton" x-placement="bottom-start">
                ...
                <a class="dropdown-item text-overflow edit-html" href="#"><i class="fa-solid fa-code"></i>Edit html</a>
                <a class="dropdown-item text-overflow remove-section" href="#"><i class="fa-solid fa-trash small"></i> Remove</a>
            </div>
        </div>
    </div>
    <div class="container p-0">
        <div class="html-editor">{!! $html ? : $default_html !!}</div>
    </div>
</div>